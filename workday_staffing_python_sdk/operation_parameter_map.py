operation_parameter_map = {
    ...
    '/jobChanges/{ID}/administrative/{subresourceID}-PATCH': {
        'parameters': [
            ...
            {
                'name': 'workersCompensationCodeOverride'
            },
            {
                'name': 'fte'
            },
            ...
            {
                'name': 'positionWorkerType'
            },
            {
                'name': 'workingFte'
            },
            {
                'name': 'specifyWorkingFte'
            },
            {
                'name': 'timeType'
            },
            ...
            {
                'name': 'endEmploymentDate'
            },
            {
                'name': 'expectedAssignmentEndDate'
            },
        ]
    },
    ...
    '/jobChanges/{ID}/jobClassification/{subresourceID}-PATCH': {
        'parameters': [
            ...
            {
                'name': 'additionalJobClassifications'
            },
        ]
    },
    ...
    '/jobChanges/{ID}/opening/{subresourceID}-PATCH': {
        'parameters': [
            ...
            {
                'name': 'headcountOption'
            },
            {
                'name': 'openingAvailableForOverlap'
            },
            {
                'name': 'id'
            },
    ...
    '/organizationAssignmentChanges-POST': {
        'parameters': [
            ...
            {
                'name': 'massActionWorksheet'
            },
            {
                'name': 'massActionHeader'
            },
            {
                'name': 'date'
            },
    ...
    '/workers/{ID}/externalSkillLevel-POST': {
        'parameters': [
            ...
            {
                'name': 'externalSkillLevel'
            },
            {
                'name': 'externalSkillId'
            },
            {
                'name': 'effectiveMoment'
            },
            {
                'name': 'context'
            },
