...
from workday_staffing_python_sdk.model.organization_assignment_changes_get_cost_center_response import OrganizationAssignmentChangesGetCostCenterResponse as OrganizationAssignmentChangesGetCostCenterResponseSchema
...
from workday_staffing_python_sdk.type.organization_assignment_changes_get_cost_center_response import OrganizationAssignmentChangesGetCostCenterResponse
...
from workday_staffing_python_sdk.pydantic.organization_assignment_changes_get_cost_center_response import OrganizationAssignmentChangesGetCostCenterResponse as OrganizationAssignmentChangesGetCostCenterResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrganizationAssignmentChangesGetCostCenterResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrganizationAssignmentChangesGetCostCenterResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_cost_center_0_mapped_args(
        self,
        id: str,
    ...
    async def _aget_cost_center_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizationAssignmentChanges/{ID}/costCenter',
            headers=_headers,
        )
...
class GetCostCenter0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cost_center_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_cost_center_0_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_cost_center_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_cost_center_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_cost_center_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCostCenter0(BaseApi):
    ...
    async def aget_cost_center_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationAssignmentChangesGetCostCenterResponsePydantic:
        raw_response = await self.raw.aget_cost_center_0(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return OrganizationAssignmentChangesGetCostCenterResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationAssignmentChangesGetCostCenterResponsePydantic, raw_response.body)
    ...
    def get_cost_center_0(
        ...
        raw_response = self.raw.get_cost_center_0(
            id=id,
            limit=limit,
            offset=offset,
        )
