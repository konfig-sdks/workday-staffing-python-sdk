...
SchemaFor200ResponseBodyApplicationJson = HomeContactChangeEventF42ba27d87ed10001aa58a5d231b1621Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_home_contact_change_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_home_contact_change_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/homeContactInformationChanges/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_home_contact_change_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetHomeContactChangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_home_contact_change(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_home_contact_change_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_home_contact_change_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_home_contact_change(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_home_contact_change_oapg(
            path_params=args.path,
        )

class GetHomeContactChange(BaseApi):
    ...
    async def aget_home_contact_change(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_home_contact_change(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_home_contact_change(
        ...
        raw_response = self.raw.get_home_contact_change(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
