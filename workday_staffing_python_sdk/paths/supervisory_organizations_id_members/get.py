...
from workday_staffing_python_sdk.model.supervisory_organizations_get_members_response import SupervisoryOrganizationsGetMembersResponse as SupervisoryOrganizationsGetMembersResponseSchema
...
from workday_staffing_python_sdk.type.supervisory_organizations_get_members_response import SupervisoryOrganizationsGetMembersResponse
...
from workday_staffing_python_sdk.pydantic.supervisory_organizations_get_members_response import SupervisoryOrganizationsGetMembersResponse as SupervisoryOrganizationsGetMembersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SupervisoryOrganizationsGetMembersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SupervisoryOrganizationsGetMembersResponse
    ...
    async def _aget_members_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/supervisoryOrganizations/{ID}/members',
            headers=_headers,
        )
...
class GetMembersRaw(BaseApi):
    ...
    async def aget_members(
        ...
        **kwargs,
        ...
        args = self._get_members_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_members_oapg(
    ...
    def get_members(
        ...
        return self._get_members_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMembers(BaseApi):
    ...
    async def aget_members(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SupervisoryOrganizationsGetMembersResponsePydantic:
        raw_response = await self.raw.aget_members(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return SupervisoryOrganizationsGetMembersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SupervisoryOrganizationsGetMembersResponsePydantic, raw_response.body)
    ...
    def get_members(
        ...
        raw_response = self.raw.get_members(
            id=id,
            limit=limit,
            offset=offset,
        )
