...
from workday_staffing_python_sdk.model.job_changes_get_position_by_id_response import JobChangesGetPositionByIdResponse as JobChangesGetPositionByIdResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_position_by_id_response import JobChangesGetPositionByIdResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_position_by_id_response import JobChangesGetPositionByIdResponse as JobChangesGetPositionByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetPositionByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetPositionByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_position_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_position_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/position',
            headers=_headers,
        )
...
class GetPositionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_position_by_id(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_position_by_id_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_position_by_id_oapg(
    ...
    def get_position_by_id(
        ...
        return self._get_position_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPositionById(BaseApi):
    ...
    async def aget_position_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetPositionByIdResponsePydantic:
        raw_response = await self.raw.aget_position_by_id(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetPositionByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetPositionByIdResponsePydantic, raw_response.body)
    ...
    def get_position_by_id(
        ...
        raw_response = self.raw.get_position_by_id(
            id=id,
            limit=limit,
            offset=offset,
        )
