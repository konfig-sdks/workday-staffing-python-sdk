...
from workday_staffing_python_sdk.model.organization_assignment_changes_get_comment_response import OrganizationAssignmentChangesGetCommentResponse as OrganizationAssignmentChangesGetCommentResponseSchema
...
from workday_staffing_python_sdk.type.organization_assignment_changes_get_comment_response import OrganizationAssignmentChangesGetCommentResponse
...
from workday_staffing_python_sdk.pydantic.organization_assignment_changes_get_comment_response import OrganizationAssignmentChangesGetCommentResponse as OrganizationAssignmentChangesGetCommentResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrganizationAssignmentChangesGetCommentResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrganizationAssignmentChangesGetCommentResponse
    ...
    async def _aget_comment_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizationAssignmentChanges/{ID}/comment',
            headers=_headers,
        )
...
class GetComment(BaseApi):
    ...
    async def aget_comment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationAssignmentChangesGetCommentResponsePydantic:
        ...
        if validate:
            return OrganizationAssignmentChangesGetCommentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationAssignmentChangesGetCommentResponsePydantic, raw_response.body)
