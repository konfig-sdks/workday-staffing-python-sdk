...
class BaseApi(api_client.Api):
    ...
    def _get_admin_options_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_admin_options_oapg(
        self,
...
class GetAdminOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_admin_options(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_admin_options_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_admin_options_oapg(
    ...
    def get_admin_options(
        ...
        return self._get_admin_options_oapg(
            path_params=args.path,
        )

class GetAdminOptions(BaseApi):
    ...
    async def aget_admin_options(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_admin_options(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_admin_options(
        ...
        raw_response = self.raw.get_admin_options(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
