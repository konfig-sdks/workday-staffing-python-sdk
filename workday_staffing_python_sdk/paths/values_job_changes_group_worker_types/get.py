...
class BaseApi(api_client.Api):
    ...
    def _get_worker_types_mapped_args(
        self,
    ...
    async def _aget_worker_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/workerTypes',
            headers=_headers,
        )
...
class GetWorkerTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_worker_types(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_worker_types_mapped_args(
        ...
        return await self._aget_worker_types_oapg(
    ...
    def get_worker_types(
        ...
        return self._get_worker_types_oapg(
            query_params=args.query,
        )

class GetWorkerTypes(BaseApi):
    ...
    async def aget_worker_types(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_worker_types(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_worker_types(
        ...
        raw_response = self.raw.get_worker_types(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
