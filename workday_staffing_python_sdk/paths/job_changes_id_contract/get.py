...
from workday_staffing_python_sdk.model.job_changes_get_contract_options_response import JobChangesGetContractOptionsResponse as JobChangesGetContractOptionsResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_contract_options_response import JobChangesGetContractOptionsResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_contract_options_response import JobChangesGetContractOptionsResponse as JobChangesGetContractOptionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetContractOptionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetContractOptionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_contract_options_mapped_args(
        self,
        id: str,
    ...
    async def _aget_contract_options_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/contract',
            headers=_headers,
        )
    ...
    def _get_contract_options_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetContractOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_contract_options(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_contract_options_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_contract_options_oapg(
    ...
    def get_contract_options(
        ...
        return self._get_contract_options_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetContractOptions(BaseApi):
    ...
    async def aget_contract_options(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetContractOptionsResponsePydantic:
        raw_response = await self.raw.aget_contract_options(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetContractOptionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetContractOptionsResponsePydantic, raw_response.body)
    ...
    def get_contract_options(
        ...
        raw_response = self.raw.get_contract_options(
            id=id,
            limit=limit,
            offset=offset,
        )
