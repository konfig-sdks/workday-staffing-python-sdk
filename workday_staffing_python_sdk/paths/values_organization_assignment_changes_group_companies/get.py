...
class BaseApi(api_client.Api):
    ...
    def _get_instances_18_mapped_args(
        self,
    ...
    async def _aget_instances_18_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/organizationAssignmentChangesGroup/companies',
            headers=_headers,
        )
...
class GetInstances18Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_18(
        self,
        effective_date: typing.Optional[date] = None,
        event: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_instances_18_mapped_args(
        ...
        return await self._aget_instances_18_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_instances_18(
        self,
        effective_date: typing.Optional[date] = None,
        event: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_instances_18_oapg(
            query_params=args.query,
        )

class GetInstances18(BaseApi):
    ...
    async def aget_instances_18(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_18(
            effective_date=effective_date,
            event=event,
            limit=limit,
            offset=offset,
    ...
    def get_instances_18(
        ...
        raw_response = self.raw.get_instances_18(
            effective_date=effective_date,
            event=event,
            limit=limit,
            offset=offset,
