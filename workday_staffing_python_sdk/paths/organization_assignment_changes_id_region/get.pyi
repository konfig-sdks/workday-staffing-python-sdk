...
from workday_staffing_python_sdk.model.organization_assignment_changes_get_region_response import OrganizationAssignmentChangesGetRegionResponse as OrganizationAssignmentChangesGetRegionResponseSchema
from workday_staffing_python_sdk.model.errormodelreference import ERRORMODELREFERENCE as ERRORMODELREFERENCESchema

from workday_staffing_python_sdk.type.organization_assignment_changes_get_region_response import OrganizationAssignmentChangesGetRegionResponse
...
from workday_staffing_python_sdk.pydantic.organization_assignment_changes_get_region_response import OrganizationAssignmentChangesGetRegionResponse as OrganizationAssignmentChangesGetRegionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrganizationAssignmentChangesGetRegionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrganizationAssignmentChangesGetRegionResponse
    ...
    async def _aget_region_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizationAssignmentChanges/{ID}/region',
            headers=_headers,
        )
...
class GetRegionRaw(BaseApi):
    ...
    async def aget_region(
        ...
        **kwargs,
        ...
        args = self._get_region_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_region_oapg(
    ...
    def get_region(
        ...
        return self._get_region_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRegion(BaseApi):
    ...
    async def aget_region(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrganizationAssignmentChangesGetRegionResponsePydantic:
        raw_response = await self.raw.aget_region(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return OrganizationAssignmentChangesGetRegionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrganizationAssignmentChangesGetRegionResponsePydantic, raw_response.body)
    ...
    def get_region(
        ...
        raw_response = self.raw.get_region(
            id=id,
            limit=limit,
            offset=offset,
        )
