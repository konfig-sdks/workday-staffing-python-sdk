...
from workday_staffing_python_sdk.model.job_changes_get_administrative_options_response import JobChangesGetAdministrativeOptionsResponse as JobChangesGetAdministrativeOptionsResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_administrative_options_response import JobChangesGetAdministrativeOptionsResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_administrative_options_response import JobChangesGetAdministrativeOptionsResponse as JobChangesGetAdministrativeOptionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetAdministrativeOptionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetAdministrativeOptionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_administrative_options_mapped_args(
        self,
        id: str,
    ...
    async def _aget_administrative_options_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/administrative',
            headers=_headers,
        )
    ...
    def _get_administrative_options_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAdministrativeOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_administrative_options(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_administrative_options_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_administrative_options_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_administrative_options(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_administrative_options_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAdministrativeOptions(BaseApi):
    ...
    async def aget_administrative_options(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetAdministrativeOptionsResponsePydantic:
        raw_response = await self.raw.aget_administrative_options(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetAdministrativeOptionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetAdministrativeOptionsResponsePydantic, raw_response.body)
    ...
    def get_administrative_options(
        ...
        raw_response = self.raw.get_administrative_options(
            id=id,
            limit=limit,
            offset=offset,
        )
