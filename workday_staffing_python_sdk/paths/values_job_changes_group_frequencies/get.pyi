...
class BaseApi(api_client.Api):
    ...
    def _get_instances_8_mapped_args(
        self,
    ...
    async def _aget_instances_8_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/frequencies',
            headers=_headers,
        )
...
class GetInstances8Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_8(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_instances_8_mapped_args(
        ...
        return await self._aget_instances_8_oapg(
    ...
    def get_instances_8(
        ...
        return self._get_instances_8_oapg(
            query_params=args.query,
        )

class GetInstances8(BaseApi):
    ...
    async def aget_instances_8(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_8(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_instances_8(
        ...
        raw_response = self.raw.get_instances_8(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
