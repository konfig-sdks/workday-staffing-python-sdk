...
SchemaFor200ResponseBodyApplicationJson = WorkContactChangeEvent5fca6c96c1c81000142fd03784140113Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_work_contact_change_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_work_contact_change_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/workContactInformationChanges/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_work_contact_change_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetWorkContactChangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_work_contact_change(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_work_contact_change_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_work_contact_change_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_work_contact_change(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_work_contact_change_oapg(
            path_params=args.path,
        )

class GetWorkContactChange(BaseApi):
    ...
    async def aget_work_contact_change(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_work_contact_change(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_work_contact_change(
        ...
        raw_response = self.raw.get_work_contact_change(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
