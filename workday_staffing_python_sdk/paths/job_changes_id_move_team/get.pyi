...
from workday_staffing_python_sdk.model.job_changes_get_move_team_option_response import JobChangesGetMoveTeamOptionResponse as JobChangesGetMoveTeamOptionResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_move_team_option_response import JobChangesGetMoveTeamOptionResponse

from ...api_client import Dictionary
from workday_staffing_python_sdk.pydantic.job_changes_get_move_team_option_response import JobChangesGetMoveTeamOptionResponse as JobChangesGetMoveTeamOptionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetMoveTeamOptionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetMoveTeamOptionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_move_team_option_0_mapped_args(
        self,
        id: str,
    ...
    async def _aget_move_team_option_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/moveTeam',
            headers=_headers,
        )
    ...
    def _get_move_team_option_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMoveTeamOption0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_move_team_option_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_move_team_option_0_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_move_team_option_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_move_team_option_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_move_team_option_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMoveTeamOption0(BaseApi):
    ...
    async def aget_move_team_option_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetMoveTeamOptionResponsePydantic:
        raw_response = await self.raw.aget_move_team_option_0(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetMoveTeamOptionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetMoveTeamOptionResponsePydantic, raw_response.body)
    ...
    def get_move_team_option_0(
        ...
        raw_response = self.raw.get_move_team_option_0(
            id=id,
            limit=limit,
            offset=offset,
        )
