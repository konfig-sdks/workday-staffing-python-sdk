...
SchemaFor200ResponseBodyApplicationJson = DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8
...
class BaseApi(api_client.Api):
    ...
    def _get_explicit_skills_for_skill_enabled_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_explicit_skills_for_skill_enabled_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/explicitSkills/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_explicit_skills_for_skill_enabled_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExplicitSkillsForSkillEnabledRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_explicit_skills_for_skill_enabled(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_explicit_skills_for_skill_enabled_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_explicit_skills_for_skill_enabled_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_explicit_skills_for_skill_enabled(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_explicit_skills_for_skill_enabled_oapg(
            path_params=args.path,
        )

class GetExplicitSkillsForSkillEnabled(BaseApi):
    ...
    async def aget_explicit_skills_for_skill_enabled(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8Pydantic:
        raw_response = await self.raw.aget_explicit_skills_for_skill_enabled(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8Pydantic](raw_response.body).root
        return api_client.construct_model_instance(DisplayExplicitSkillRepresentationD6ca778018011000182fa5be1ae901a8Pydantic, raw_response.body)
    ...
    def get_explicit_skills_for_skill_enabled(
        ...
        raw_response = self.raw.get_explicit_skills_for_skill_enabled(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
