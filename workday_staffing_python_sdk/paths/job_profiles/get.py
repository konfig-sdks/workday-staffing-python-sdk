...
from workday_staffing_python_sdk.model.job_profiles_list_collection_response import JobProfilesListCollectionResponse as JobProfilesListCollectionResponseSchema
...
from workday_staffing_python_sdk.type.job_profiles_list_collection_response import JobProfilesListCollectionResponse
...
from workday_staffing_python_sdk.pydantic.job_profiles_list_collection_response import JobProfilesListCollectionResponse as JobProfilesListCollectionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobProfilesListCollectionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobProfilesListCollectionResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_collection_mapped_args(
        self,
    ...
    async def _alist_collection_oapg(
        self,
...
class ListCollectionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_collection(
        self,
        include_inactive: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_collection_mapped_args(
            include_inactive=include_inactive,
            limit=limit,
            offset=offset,
        )
        return await self._alist_collection_oapg(
    ...
    def list_collection(
        ...
        return self._list_collection_oapg(
            query_params=args.query,
        )

class ListCollection(BaseApi):
    ...
    async def alist_collection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobProfilesListCollectionResponsePydantic:
        raw_response = await self.raw.alist_collection(
            include_inactive=include_inactive,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobProfilesListCollectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobProfilesListCollectionResponsePydantic, raw_response.body)
    ...
    def list_collection(
        ...
        raw_response = self.raw.list_collection(
            include_inactive=include_inactive,
            limit=limit,
            offset=offset,
        )
