    ...
    async def _aget_options_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/headcountOptions',
            headers=_headers,
        )
...
class GetOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_options(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_options_mapped_args(
        ...
        return await self._aget_options_oapg(
...
class GetOptions(BaseApi):
    ...
    async def aget_options(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_options(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_options(
        ...
        raw_response = self.raw.get_options(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
