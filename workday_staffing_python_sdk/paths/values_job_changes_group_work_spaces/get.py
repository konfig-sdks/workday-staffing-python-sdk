...
class BaseApi(api_client.Api):
    ...
    def _get_workspace_instances_mapped_args(
        self,
    ...
    async def _aget_workspace_instances_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/workSpaces',
            headers=_headers,
        )
    ...
    def _get_workspace_instances_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetWorkspaceInstancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_workspace_instances(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_workspace_instances_mapped_args(
        ...
        return await self._aget_workspace_instances_oapg(
    ...
    def get_workspace_instances(
        ...
        return self._get_workspace_instances_oapg(
            query_params=args.query,
        )

class GetWorkspaceInstances(BaseApi):
    ...
    async def aget_workspace_instances(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_workspace_instances(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_workspace_instances(
        ...
        raw_response = self.raw.get_workspace_instances(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
