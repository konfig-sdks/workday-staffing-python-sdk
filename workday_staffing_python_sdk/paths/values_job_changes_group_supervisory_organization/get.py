...
class BaseApi(api_client.Api):
    ...
    def _get_supervisory_org_values_mapped_args(
        self,
    ...
    async def _aget_supervisory_org_values_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/supervisoryOrganization',
            headers=_headers,
        )
    ...
    def _get_supervisory_org_values_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSupervisoryOrgValuesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_supervisory_org_values(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_supervisory_org_values_mapped_args(
        ...
        return await self._aget_supervisory_org_values_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_supervisory_org_values(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_supervisory_org_values_oapg(
            query_params=args.query,
        )

class GetSupervisoryOrgValues(BaseApi):
    ...
    async def aget_supervisory_org_values(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_supervisory_org_values(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_supervisory_org_values(
        ...
        raw_response = self.raw.get_supervisory_org_values(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
