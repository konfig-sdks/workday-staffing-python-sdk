...
class GetProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_profile(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_profile_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_profile_oapg(
    ...
    def get_profile(
        ...
        return self._get_profile_oapg(
            path_params=args.path,
        )

class GetProfile(BaseApi):
    ...
    async def aget_profile(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_profile(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_profile(
        ...
        raw_response = self.raw.get_profile(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
