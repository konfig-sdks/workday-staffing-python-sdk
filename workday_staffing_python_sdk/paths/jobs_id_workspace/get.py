...
from workday_staffing_python_sdk.model.jobs_get_workspaces_response import JobsGetWorkspacesResponse as JobsGetWorkspacesResponseSchema
...
from workday_staffing_python_sdk.type.jobs_get_workspaces_response import JobsGetWorkspacesResponse
...
from workday_staffing_python_sdk.pydantic.jobs_get_workspaces_response import JobsGetWorkspacesResponse as JobsGetWorkspacesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobsGetWorkspacesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobsGetWorkspacesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_workspaces_mapped_args(
        self,
        id: str,
    ...
    async def _aget_workspaces_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobs/{ID}/workspace',
            headers=_headers,
        )
...
class GetWorkspacesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_workspaces(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_workspaces_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_workspaces_oapg(
...
class GetWorkspaces(BaseApi):
    ...
    async def aget_workspaces(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobsGetWorkspacesResponsePydantic:
        raw_response = await self.raw.aget_workspaces(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobsGetWorkspacesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobsGetWorkspacesResponsePydantic, raw_response.body)
    ...
    def get_workspaces(
        ...
        raw_response = self.raw.get_workspaces(
            id=id,
            limit=limit,
            offset=offset,
        )
