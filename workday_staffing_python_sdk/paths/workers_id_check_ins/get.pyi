...
from workday_staffing_python_sdk.model.workers_get_check_ins_response import WorkersGetCheckInsResponse as WorkersGetCheckInsResponseSchema
...
from workday_staffing_python_sdk.type.workers_get_check_ins_response import WorkersGetCheckInsResponse
...
from workday_staffing_python_sdk.pydantic.workers_get_check_ins_response import WorkersGetCheckInsResponse as WorkersGetCheckInsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkersGetCheckInsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkersGetCheckInsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_check_ins_mapped_args(
        self,
        id: str,
    ...
    async def _aget_check_ins_oapg(
        self,
...
class GetCheckInsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_check_ins(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_check_ins_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_check_ins_oapg(
    ...
    def get_check_ins(
        ...
        return self._get_check_ins_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCheckIns(BaseApi):
    ...
    async def aget_check_ins(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkersGetCheckInsResponsePydantic:
        raw_response = await self.raw.aget_check_ins(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return WorkersGetCheckInsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkersGetCheckInsResponsePydantic, raw_response.body)
    ...
    def get_check_ins(
        ...
        raw_response = self.raw.get_check_ins(
            id=id,
            limit=limit,
            offset=offset,
        )
