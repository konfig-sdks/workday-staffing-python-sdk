...
class BaseApi(api_client.Api):
    ...
    def _get_instances_17_mapped_args(
        self,
    ...
    async def _aget_instances_17_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/jobProfiles',
            headers=_headers,
        )
...
class GetInstances17Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_17(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_instances_17_mapped_args(
        ...
        return await self._aget_instances_17_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_instances_17(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_instances_17_oapg(
            query_params=args.query,
        )

class GetInstances17(BaseApi):
    ...
    async def aget_instances_17(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_17(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_instances_17(
        ...
        raw_response = self.raw.get_instances_17(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
