...
from workday_staffing_python_sdk.model.job_workspace_data1005157e3d631000144205466a6c13d3 import JobWorkspaceData1005157e3d631000144205466a6c13d3 as JobWorkspaceData1005157e3d631000144205466a6c13d3Schema
...
from workday_staffing_python_sdk.pydantic.job_workspace_data1005157e3d631000144205466a6c13d3 import JobWorkspaceData1005157e3d631000144205466a6c13d3 as JobWorkspaceData1005157e3d631000144205466a6c13d3Pydantic
...
SchemaFor200ResponseBodyApplicationJson = JobWorkspaceData1005157e3d631000144205466a6c13d3Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobWorkspaceData1005157e3d631000144205466a6c13d3
    ...
    async def _aget_workspace_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobs/{ID}/workspace/{subresourceID}',
            headers=_headers,
        )
...
class GetWorkspace(BaseApi):
    ...
    async def aget_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobWorkspaceData1005157e3d631000144205466a6c13d3Pydantic:
        ...
        if validate:
            return RootModel[JobWorkspaceData1005157e3d631000144205466a6c13d3Pydantic](raw_response.body).root
        return api_client.construct_model_instance(JobWorkspaceData1005157e3d631000144205466a6c13d3Pydantic, raw_response.body)
