    ...
    async def _aget_grants_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/organizationAssignmentChangesGroup/grants',
            headers=_headers,
        )
...
class GetGrantsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_grants(
        self,
        effective_date: typing.Optional[date] = None,
        event: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_grants_mapped_args(
        ...
        return await self._aget_grants_oapg(
    ...
    def get_grants(
        ...
        return self._get_grants_oapg(
            query_params=args.query,
        )

class GetGrants(BaseApi):
    ...
    async def aget_grants(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_grants(
            effective_date=effective_date,
            event=event,
            limit=limit,
            offset=offset,
    ...
    def get_grants(
        ...
        raw_response = self.raw.get_grants(
            effective_date=effective_date,
            event=event,
            limit=limit,
            offset=offset,
