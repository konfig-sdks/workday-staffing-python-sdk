...
from workday_staffing_python_sdk.model.job_families_list_response import JobFamiliesListResponse as JobFamiliesListResponseSchema
...
from workday_staffing_python_sdk.type.job_families_list_response import JobFamiliesListResponse
...
from workday_staffing_python_sdk.pydantic.job_families_list_response import JobFamiliesListResponse as JobFamiliesListResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'jobFamilyGroup': typing.Union[JobFamilyGroupSchema, list, tuple, ],
        'jobProfile': typing.Union[JobProfileSchema, list, tuple, ],
...
request_query_job_family_group = api_client.QueryParameter(
    name="jobFamilyGroup",
    style=api_client.ParameterStyle.FORM,
    schema=JobFamilyGroupSchema,
    explode=True,
)
request_query_job_profile = api_client.QueryParameter(
    name="jobProfile",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = JobFamiliesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobFamiliesListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        job_family_group: typing.Optional[typing.List[str]] = None,
        job_profile: typing.Optional[typing.List[str]] = None,
        ...
        if job_family_group is not None:
            _query_params["jobFamilyGroup"] = job_family_group
        if job_profile is not None:
            _query_params["jobProfile"] = job_profile
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_job_family_group,
            request_query_job_profile,
            request_query_limit,
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobFamiliesListResponsePydantic:
        ...
        if validate:
            return JobFamiliesListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobFamiliesListResponsePydantic, raw_response.body)
