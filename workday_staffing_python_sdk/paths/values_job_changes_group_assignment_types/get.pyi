...
class BaseApi(api_client.Api):
    ...
    def _get_assignment_types_mapped_args(
        self,
    ...
    async def _aget_assignment_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/assignmentTypes',
            headers=_headers,
        )
    ...
    def _get_assignment_types_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAssignmentTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_assignment_types(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_assignment_types_mapped_args(
        ...
        return await self._aget_assignment_types_oapg(
    ...
    def get_assignment_types(
        ...
        return self._get_assignment_types_oapg(
            query_params=args.query,
        )

class GetAssignmentTypes(BaseApi):
    ...
    async def aget_assignment_types(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_assignment_types(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_assignment_types(
        ...
        raw_response = self.raw.get_assignment_types(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
