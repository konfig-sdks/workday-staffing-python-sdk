...
from workday_staffing_python_sdk.model.job_changes_get_opening_options_response import JobChangesGetOpeningOptionsResponse as JobChangesGetOpeningOptionsResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_opening_options_response import JobChangesGetOpeningOptionsResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_opening_options_response import JobChangesGetOpeningOptionsResponse as JobChangesGetOpeningOptionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetOpeningOptionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetOpeningOptionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_opening_options_mapped_args(
        self,
        id: str,
    ...
    async def _aget_opening_options_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/opening',
            headers=_headers,
        )
...
class GetOpeningOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_opening_options(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_opening_options_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_opening_options_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_opening_options(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_opening_options_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOpeningOptions(BaseApi):
    ...
    async def aget_opening_options(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetOpeningOptionsResponsePydantic:
        raw_response = await self.raw.aget_opening_options(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetOpeningOptionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetOpeningOptionsResponsePydantic, raw_response.body)
    ...
    def get_opening_options(
        ...
        raw_response = self.raw.get_opening_options(
            id=id,
            limit=limit,
            offset=offset,
        )
