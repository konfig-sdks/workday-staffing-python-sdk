...
from workday_staffing_python_sdk.model.job_changes_get_job_profile_response import JobChangesGetJobProfileResponse as JobChangesGetJobProfileResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_job_profile_response import JobChangesGetJobProfileResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_job_profile_response import JobChangesGetJobProfileResponse as JobChangesGetJobProfileResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetJobProfileResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetJobProfileResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_job_profile_mapped_args(
        self,
        id: str,
    ...
    async def _aget_job_profile_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/jobProfile',
            headers=_headers,
        )
...
class GetJobProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_job_profile(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_job_profile_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_job_profile_oapg(
    ...
    def get_job_profile(
        ...
        return self._get_job_profile_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetJobProfile(BaseApi):
    ...
    async def aget_job_profile(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetJobProfileResponsePydantic:
        raw_response = await self.raw.aget_job_profile(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetJobProfileResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetJobProfileResponsePydantic, raw_response.body)
    ...
    def get_job_profile(
        ...
        raw_response = self.raw.get_job_profile(
            id=id,
            limit=limit,
            offset=offset,
        )
