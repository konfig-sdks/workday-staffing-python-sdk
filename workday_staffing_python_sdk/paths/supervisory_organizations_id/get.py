...
from workday_staffing_python_sdk.model.supervisory_organization_view_a02c2e1916fa100009e137235f1f0018 import SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018 as SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018Schema
...
from workday_staffing_python_sdk.pydantic.supervisory_organization_view_a02c2e1916fa100009e137235f1f0018 import SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018 as SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018Pydantic
...
SchemaFor200ResponseBodyApplicationJson = SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018
    ...
    async def _aget_instance_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/supervisoryOrganizations/{ID}',
            headers=_headers,
        )
...
class GetInstance(BaseApi):
    ...
    async def aget_instance(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018Pydantic:
        raw_response = await self.raw.aget_instance(
            id=id,
            **kwargs,
        )
        if validate:
            return RootModel[SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018Pydantic](raw_response.body).root
        return api_client.construct_model_instance(SupervisoryOrganizationViewA02c2e1916fa100009e137235f1f0018Pydantic, raw_response.body)
