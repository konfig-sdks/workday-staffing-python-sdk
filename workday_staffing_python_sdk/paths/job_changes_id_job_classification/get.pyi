...
from workday_staffing_python_sdk.model.job_changes_get_job_classification_response import JobChangesGetJobClassificationResponse as JobChangesGetJobClassificationResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_job_classification_response import JobChangesGetJobClassificationResponse

from ...api_client import Dictionary
from workday_staffing_python_sdk.pydantic.job_changes_get_job_classification_response import JobChangesGetJobClassificationResponse as JobChangesGetJobClassificationResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetJobClassificationResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetJobClassificationResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_job_classification_mapped_args(
        self,
        id: str,
    ...
    async def _aget_job_classification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/jobClassification',
            headers=_headers,
        )
    ...
    def _get_job_classification_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetJobClassificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_job_classification(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_job_classification_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_job_classification_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_job_classification(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_job_classification_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetJobClassification(BaseApi):
    ...
    async def aget_job_classification(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetJobClassificationResponsePydantic:
        raw_response = await self.raw.aget_job_classification(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetJobClassificationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetJobClassificationResponsePydantic, raw_response.body)
    ...
    def get_job_classification(
        ...
        raw_response = self.raw.get_job_classification(
            id=id,
            limit=limit,
            offset=offset,
        )
