...
from workday_staffing_python_sdk.model.job_changes_get_business_title_response import JobChangesGetBusinessTitleResponse as JobChangesGetBusinessTitleResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_business_title_response import JobChangesGetBusinessTitleResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_business_title_response import JobChangesGetBusinessTitleResponse as JobChangesGetBusinessTitleResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetBusinessTitleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetBusinessTitleResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_business_title_0_mapped_args(
        self,
        id: str,
    ...
    async def _aget_business_title_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/businessTitle',
            headers=_headers,
        )
    ...
    def _get_business_title_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBusinessTitle0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_business_title_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_business_title_0_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_business_title_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_business_title_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_business_title_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBusinessTitle0(BaseApi):
    ...
    async def aget_business_title_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetBusinessTitleResponsePydantic:
        raw_response = await self.raw.aget_business_title_0(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetBusinessTitleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetBusinessTitleResponsePydantic, raw_response.body)
    ...
    def get_business_title_0(
        ...
        raw_response = self.raw.get_business_title_0(
            id=id,
            limit=limit,
            offset=offset,
        )
