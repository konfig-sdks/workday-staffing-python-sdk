...
from workday_staffing_python_sdk.model.comments7d98fd55aeee100022968e52a1b31c60 import Comments7d98fd55aeee100022968e52a1b31c60 as Comments7d98fd55aeee100022968e52a1b31c60Schema
...
from workday_staffing_python_sdk.pydantic.comments7d98fd55aeee100022968e52a1b31c60 import Comments7d98fd55aeee100022968e52a1b31c60 as Comments7d98fd55aeee100022968e52a1b31c60Pydantic
...
SchemaFor200ResponseBodyApplicationJson = Comments7d98fd55aeee100022968e52a1b31c60Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: Comments7d98fd55aeee100022968e52a1b31c60
...
class BaseApi(api_client.Api):
    ...
    def _get_comment_info_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_comment_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/organizationAssignmentChanges/{ID}/comment/{subresourceID}',
            headers=_headers,
        )
...
class GetCommentInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_comment_info(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_comment_info_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_comment_info_oapg(
    ...
    def get_comment_info(
        ...
        return self._get_comment_info_oapg(
            path_params=args.path,
        )

class GetCommentInfo(BaseApi):
    ...
    async def aget_comment_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> Comments7d98fd55aeee100022968e52a1b31c60Pydantic:
        raw_response = await self.raw.aget_comment_info(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[Comments7d98fd55aeee100022968e52a1b31c60Pydantic](raw_response.body).root
        return api_client.construct_model_instance(Comments7d98fd55aeee100022968e52a1b31c60Pydantic, raw_response.body)
    ...
    def get_comment_info(
        ...
        raw_response = self.raw.get_comment_info(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
