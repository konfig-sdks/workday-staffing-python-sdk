...
from workday_staffing_python_sdk.model.job_changes_get_comment_by_id_response import JobChangesGetCommentByIdResponse as JobChangesGetCommentByIdResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_comment_by_id_response import JobChangesGetCommentByIdResponse

from ...api_client import Dictionary
from workday_staffing_python_sdk.pydantic.job_changes_get_comment_by_id_response import JobChangesGetCommentByIdResponse as JobChangesGetCommentByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetCommentByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetCommentByIdResponse
    ...
    async def _aget_comment_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/comment',
            headers=_headers,
        )
...
class GetCommentById(BaseApi):
    ...
    async def aget_comment_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetCommentByIdResponsePydantic:
        ...
        if validate:
            return JobChangesGetCommentByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetCommentByIdResponsePydantic, raw_response.body)
