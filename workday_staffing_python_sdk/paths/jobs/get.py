...
from workday_staffing_python_sdk.model.jobs_get_collection_response import JobsGetCollectionResponse as JobsGetCollectionResponseSchema
...
from workday_staffing_python_sdk.type.jobs_get_collection_response import JobsGetCollectionResponse

from ...api_client import Dictionary
from workday_staffing_python_sdk.pydantic.jobs_get_collection_response import JobsGetCollectionResponse as JobsGetCollectionResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobsGetCollectionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobsGetCollectionResponse
...
class GetCollection(BaseApi):
    ...
    async def aget_collection(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobsGetCollectionResponsePydantic:
        ...
        if validate:
            return JobsGetCollectionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobsGetCollectionResponsePydantic, raw_response.body)
