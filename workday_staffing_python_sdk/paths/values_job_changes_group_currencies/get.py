...
class BaseApi(api_client.Api):
    ...
    def _get_currency_instances_mapped_args(
        self,
    ...
    async def _aget_currency_instances_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/currencies',
            headers=_headers,
        )
    ...
    def _get_currency_instances_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCurrencyInstancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_currency_instances(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_currency_instances_mapped_args(
        ...
        return await self._aget_currency_instances_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_currency_instances(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_currency_instances_oapg(
            query_params=args.query,
        )

class GetCurrencyInstances(BaseApi):
    ...
    async def aget_currency_instances(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_currency_instances(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_currency_instances(
        ...
        raw_response = self.raw.get_currency_instances(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
