...
class BaseApi(api_client.Api):
    ...
    def _get_instances_4_mapped_args(
        self,
    ...
    async def _aget_instances_4_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/organizationAssignmentChangesGroup/funds',
            headers=_headers,
        )
...
class GetInstances4Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_instances_4(
        self,
        effective_date: typing.Optional[date] = None,
        event: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_instances_4_mapped_args(
        ...
        return await self._aget_instances_4_oapg(
    ...
    def get_instances_4(
        ...
        return self._get_instances_4_oapg(
            query_params=args.query,
        )

class GetInstances4(BaseApi):
    ...
    async def aget_instances_4(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_instances_4(
            effective_date=effective_date,
            event=event,
            limit=limit,
            offset=offset,
    ...
    def get_instances_4(
        ...
        raw_response = self.raw.get_instances_4(
            effective_date=effective_date,
            event=event,
            limit=limit,
            offset=offset,
