...
class BaseApi(api_client.Api):
    ...
    def _get_proposed_positions_mapped_args(
        self,
    ...
    async def _aget_proposed_positions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/jobChangesGroup/proposedPosition',
            headers=_headers,
        )
    ...
    def _get_proposed_positions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetProposedPositionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_proposed_positions(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_proposed_positions_mapped_args(
        ...
        return await self._aget_proposed_positions_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_proposed_positions(
        self,
        effective_date: typing.Optional[date] = None,
        job: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_proposed_positions_oapg(
            query_params=args.query,
        )

class GetProposedPositions(BaseApi):
    ...
    async def aget_proposed_positions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_proposed_positions(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
    ...
    def get_proposed_positions(
        ...
        raw_response = self.raw.get_proposed_positions(
            effective_date=effective_date,
            job=job,
            limit=limit,
            location=location,
