...
from workday_staffing_python_sdk.model.workers_get_service_dates_response import WorkersGetServiceDatesResponse as WorkersGetServiceDatesResponseSchema

from workday_staffing_python_sdk.type.workers_get_service_dates_response import WorkersGetServiceDatesResponse
...
from workday_staffing_python_sdk.pydantic.workers_get_service_dates_response import WorkersGetServiceDatesResponse as WorkersGetServiceDatesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkersGetServiceDatesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkersGetServiceDatesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_service_dates_mapped_args(
        self,
        id: str,
    ...
    async def _aget_service_dates_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workers/{ID}/serviceDates',
            headers=_headers,
        )
...
class GetServiceDatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_service_dates(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_service_dates_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_service_dates_oapg(
    ...
    def get_service_dates(
        ...
        return self._get_service_dates_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetServiceDates(BaseApi):
    ...
    async def aget_service_dates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkersGetServiceDatesResponsePydantic:
        raw_response = await self.raw.aget_service_dates(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return WorkersGetServiceDatesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkersGetServiceDatesResponsePydantic, raw_response.body)
    ...
    def get_service_dates(
        ...
        raw_response = self.raw.get_service_dates(
            id=id,
            limit=limit,
            offset=offset,
        )
