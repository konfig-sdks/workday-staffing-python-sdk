...
from workday_staffing_python_sdk.model.external_skill_level_detail1c67ac98c0f310002706be33dcdb0000 import ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000 as ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000Schema
...
from workday_staffing_python_sdk.pydantic.external_skill_level_detail1c67ac98c0f310002706be33dcdb0000 import ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000 as ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000Pydantic
...
SchemaFor200ResponseBodyApplicationJson = ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000
...
class BaseApi(api_client.Api):
    ...
    def _get_external_skill_levels_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_external_skill_levels_oapg(
        self,
    ...
    def _get_external_skill_levels_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExternalSkillLevelsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_external_skill_levels(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_external_skill_levels_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_external_skill_levels_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_external_skill_levels(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_external_skill_levels_oapg(
            path_params=args.path,
        )

class GetExternalSkillLevels(BaseApi):
    ...
    async def aget_external_skill_levels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000Pydantic:
        raw_response = await self.raw.aget_external_skill_levels(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000Pydantic](raw_response.body).root
        return api_client.construct_model_instance(ExternalSkillLevelDetail1c67ac98c0f310002706be33dcdb0000Pydantic, raw_response.body)
    ...
    def get_external_skill_levels(
        ...
        raw_response = self.raw.get_external_skill_levels(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
