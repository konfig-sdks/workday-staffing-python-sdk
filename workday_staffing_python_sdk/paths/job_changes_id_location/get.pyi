...
from workday_staffing_python_sdk.model.job_changes_get_location_info_response import JobChangesGetLocationInfoResponse as JobChangesGetLocationInfoResponseSchema
...
from workday_staffing_python_sdk.type.job_changes_get_location_info_response import JobChangesGetLocationInfoResponse
...
from workday_staffing_python_sdk.pydantic.job_changes_get_location_info_response import JobChangesGetLocationInfoResponse as JobChangesGetLocationInfoResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobChangesGetLocationInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobChangesGetLocationInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_location_info_mapped_args(
        self,
        id: str,
    ...
    async def _aget_location_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/jobChanges/{ID}/location',
            headers=_headers,
        )
...
class GetLocationInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_location_info(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_location_info_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_location_info_oapg(
    ...
    def get_location_info(
        ...
        return self._get_location_info_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetLocationInfo(BaseApi):
    ...
    async def aget_location_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JobChangesGetLocationInfoResponsePydantic:
        raw_response = await self.raw.aget_location_info(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return JobChangesGetLocationInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobChangesGetLocationInfoResponsePydantic, raw_response.body)
    ...
    def get_location_info(
        ...
        raw_response = self.raw.get_location_info(
            id=id,
            limit=limit,
            offset=offset,
        )
