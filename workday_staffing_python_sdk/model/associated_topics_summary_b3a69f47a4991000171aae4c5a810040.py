...
class AssociatedTopicsSummaryB3a69f47a4991000171aae4c5a810040(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "archived", "id", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "archived", "id", ], str]):
