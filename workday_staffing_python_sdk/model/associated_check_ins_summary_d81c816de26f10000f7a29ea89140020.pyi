...
class AssociatedCheckInsSummaryD81c816de26f10000f7a29ea89140020(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["archived", "date", "id", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["archived", "date", "id", ], str]):
