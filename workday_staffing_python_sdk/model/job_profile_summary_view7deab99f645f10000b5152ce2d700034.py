...
class JobProfileSummaryView7deab99f645f10000b5152ce2d700034(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["inactive", "name", "id", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["inactive", "name", "id", ], str]):
