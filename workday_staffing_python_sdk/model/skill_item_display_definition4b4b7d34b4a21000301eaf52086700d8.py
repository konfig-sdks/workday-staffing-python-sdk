...
class SkillItemDisplayDefinition4b4b7d34b4a21000301eaf52086700d8(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["skillName", "remoteID", "id", "descriptor", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["skillName", "remoteID", "id", "descriptor", ], str]):
