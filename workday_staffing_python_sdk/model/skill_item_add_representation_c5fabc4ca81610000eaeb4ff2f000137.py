...
class SkillItemAddRepresentationC5fabc4ca81610000eaeb4ff2f000137(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["skillName", "remoteID", "id", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["skillName", "remoteID", "id", ], str]):
