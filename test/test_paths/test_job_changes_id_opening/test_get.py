...
from workday_staffing_python_sdk.paths.job_changes_id_opening import get
from workday_staffing_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestJobChangesIDOpening(ApiTestMixin, unittest.TestCase):
    """
    JobChangesIDOpening unit test stubs
