...
from workday_staffing_python_sdk.paths.job_changes_id_comment import get
from workday_staffing_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestJobChangesIDComment(ApiTestMixin, unittest.TestCase):
    """
    JobChangesIDComment unit test stubs
