...
from workday_staffing_python_sdk.paths.job_changes_id_location import get
from workday_staffing_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestJobChangesIDLocation(ApiTestMixin, unittest.TestCase):
    """
    JobChangesIDLocation unit test stubs
