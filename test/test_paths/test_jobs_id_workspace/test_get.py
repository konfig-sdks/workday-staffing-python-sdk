...
from workday_staffing_python_sdk.paths.jobs_id_workspace import get
from workday_staffing_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestJobsIDWorkspace(ApiTestMixin, unittest.TestCase):
    """
    JobsIDWorkspace unit test stubs
